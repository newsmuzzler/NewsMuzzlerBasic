# NewsMuzzler
***NewsMuzzler*** is an example of a third-party application built on the Prifina platform that will be able to give the user some form of privacy with and control over their data. 
